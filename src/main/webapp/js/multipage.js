(function($) {
	...
	jQuery.fn.multipage = function(options) {
		...
		settings = jQuery.extend({stayLinkable:false,submitLabel:'Save Changes',hideLegend:true,hideSubmit:false,generateNavigation:true,activeDot:'&nbsp;&#x25CF;',inactiveDot:'&nbsp;&middot;'},options);
		id = '#' + $(this).attr('id');
		var form = $(this);
